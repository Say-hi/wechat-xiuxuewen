...
Page({
  ...
  getMoreNext: function getMoreNext() {
    this.getEvaluate();
  },
  ...
  collectO: function collectO() {
    var that = this;
    app.userCollect(that.data.collect, that.data.options.id, that.data.info.user_id, 4).then(function () {
...
//# sourceMappingURL=answerDetail2.js.map
